...
namespace App\Models {
  ...
  /**
   * App\Models\Category_post
   *
   * @method static \Illuminate\Database\Eloquent\Builder<Category_post>|Category_post newModelQuery()
   * @method static \Illuminate\Database\Eloquent\Builder<Category_post>|Category_post newQuery()
   * @method static \Illuminate\Database\Eloquent\Builder<Category_post>|Category_post query()
   * @method static mixed select($columns)
   * @method static mixed selectSub($query, $as)
   * @method static mixed selectExpression($expression, $as)
   * @method static mixed selectRaw($expression, array $bindings)
   ...
   * @mixin \Illuminate\Database\Query\Builder
   */
  class Category_post extends \Illuminate\Database\Eloquent\Model
  {
    //
  }
