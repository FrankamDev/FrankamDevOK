...
const plans = [
  {
    name: "Starter",
    price: "3 500",
    description: "Idéal pour les apprenants, freelances et petits projets",
    features: [
      "Accès à tous les cours de base",
      "10 projets guidés par mois",
      "Corrections IA de base",
      "Support par email",
      "Accès mobile",
  ...
  },
  {
    name: "Pro",
    price: "9 900",
    description: "Le choix parfait pour progresser sérieusement",
    features: [
      "Tous les cours + modules avancés",
      "Projets illimités",
      "Corrections IA avancées + feedback détaillé",
      "Support prioritaire (réponse < 4h)",
      "Accès mobile",
      "Certificats premium",
      "Accès aux lives mensuels",
      "Templates & boilerplates exclusifs",
    ],
    mostPopular: true,
  },
  {
    name: "Elite",
    price: "19 500",
    description: "Pour ceux qui veulent passer pro ou former une équipe",
    features: [
      "Accès TOTAL à toute la plateforme",
      "Projets & défis illimités",
      "Corrections IA + revue humaine par un senior",
      "Support prioritaire 24/7 via WhatsApp",
      "Accès mobile",
      "Certificats premium + badge LinkedIn",
      "Accès aux lives & masterclass exclusives",
      "Templates, boilerplates & ressources pro",
      "1 session de mentorat individuel par mois",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          ...
          <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto">
            Choisis le plan qui correspond à ton niveau et à ton budget.
            Tous les abonnements commencent par{" "}
            <span className="text-cyan-400 font-semibold">7 jours gratuits</span>.
          </p>
        </div>
        ...
        <div className="mt-10 sm:mt-16 text-center">
          <p className="text-gray-400 text-base sm:text-lg">
            Tu veux un plan sur mesure pour ton équipe / ton école / ta formation ?
