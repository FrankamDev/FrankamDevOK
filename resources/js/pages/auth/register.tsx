...
//       {/* Conteneur principal - Centrage parfait assuré par flex items-center justify-center */}
//       <div className="relative flex min-h-screen w-full items-center justify-center overflow-x-hidden bg-gradient-to-br from-[#0E1126] via-[#020013] to-[#0E1126] p-4 sm:p-6 md:p-10">

//         {/* Orbes animés */}
//         <motion.div
//           animate={{ x: [-200, 200, -200], y: [-100, 100, -100] }}
//           transition={{ duration: 30, repeat: Infinity, ease: 'linear' }}
//           className="absolute rounded-full -top-40 -left-40 h-96 w-96 bg-cyan-500/10 blur-3xl pointer-events-none"
//         />
//         <motion.div
//           animate={{ x: [200, -200, 200], y: [100, -100, 100] }}
//           transition={{ duration: 35, repeat: Infinity, ease: 'linear' }}
//           className="absolute rounded-full -bottom-40 -right-40 h-96 w-96 bg-teal-600/10 blur-3xl pointer-events-none"
//         />

//         {/* La Carte - Centrée avec mx-auto et w-full */}
//         <div className="relative z-10 grid w-full max-w-6xl mx-auto overflow-hidden border shadow-2xl rounded-3xl border-white/5 md:grid-cols-2 bg-[#020013]/50 backdrop-blur-sm">
...
//               <span className="text-2xl font-bold text-white tracking-tight">FrankamDev</span>
//             </div>
...
//             initial={{ opacity: 0, x: 50 }}
//             animate={{ opacity: 1, x: 0 }}
//             className="flex flex-col justify-center border-l border-white/5 bg-[#020013]/95 p-8 sm:p-12 md:p-16 backdrop-blur-2xl"
//           >
//             {/* Logo Mobile Centré */}
...
//               <span className="text-3xl font-bold text-white">FrankamDev</span>
//             </div>
...
//                 <span className="bg-[#020013] px-4 text-zinc-500 tracking-widest uppercase">Ou s'inscrire avec email</span>
//               </div>
//             </div>
...
//                     className="absolute -translate-y-1/2 top-1/2 right-4 text-zinc-400 hover:text-cyan-400 transition-colors">
...
//               {/* Confirmation */}
//               <div className="space-y-1.5">
//                 <label className="block text-sm font-medium text-zinc-300">Confirmer le mot de passe</label>
//                 <div className="relative">
//                   <input
...
//               {/* Photo de profil */}
//               <div className="space-y-1.5">
//                 <label className="block text-sm font-medium text-zinc-300">Photo de profil (optionnel)</label>
//                 <input id="avatar" type="file" accept="image/*" onChange={handleFileChange} className="hidden" />
//                 <motion.label
//                   htmlFor="avatar"
//                   whileHover={{ scale: 1.01 }}
//                   whileTap={{ scale: 0.99 }}
//                   className="flex items-center justify-center w-full gap-2 px-4 py-3 text-sm text-white transition border border-dashed cursor-pointer rounded-xl border-white/20 bg-white/5 backdrop-blur-sm hover:border-cyan-500/50 hover:bg-white/10"
//                 >
...
//                   <img src={preview} alt="Aperçu" className="object-cover w-14 h-14 border-2 rounded-full border-cyan-500/50" />
//                   <button type="button" onClick={removePhoto}
//                     className="flex items-center gap-1 px-3 py-1.5 text-xs text-red-400 transition rounded-lg bg-red-500/10 hover:bg-red-500/20">
//                     <X size={14} /> Supprimer
//                   </button>
//                 </motion.div>
//               )}
...
//                 type="submit"
//                 disabled={processing}
//                 className="flex items-center justify-center w-full gap-3 py-4 mt-4 font-bold text-white transition-all shadow-xl rounded-xl bg-gradient-to-r from-cyan-500 to-teal-600 shadow-cyan-500/20 hover:shadow-cyan-500/40 disabled:opacity-50 disabled:cursor-not-allowed"
//               >
...
//               Déjà un compte ?{' '}
//               <Link prefetch href="/login" className="font-semibold text-cyan-400 hover:text-cyan-300 transition-colors">
//                 Connectez-vous
//               </Link>
//             </div>

//             <div className="mt-8 text-[10px] text-center text-zinc-600 uppercase tracking-widest font-medium">
//               © 2026 frankamdev. Tous droits réservés.
//             </div>
//           </motion.div>
//         </div>
//       </div>
    ...
    <>
      ...
      <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-[#0E1126] via-[#020013] to-[#0E1126] p-6">
        ...
        <motion.div
          animate={{ x: [200, -200, 200], y: [100, -100, 100] }}
          transition={{ duration: 35, repeat: Infinity, ease: 'linear' }}
          className="absolute rounded-full  -bottom-40 h-96 w-96 bg-teal-600/10 blur-3xl"
        />
