...
const BlogIndex: React.FC<BlogIndexProps> = ({ className = '' }) => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950/5 to-purple-950/5 pb-20 pt-6 md:pt-10">
        {/* ==================== HEADER ==================== */}
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="relative mx-auto max-w-5xl px-5 sm:px-6 lg:px-8 pt-8 pb-16 md:pb-20 text-center">
            {/* Glow subtil en arrière-plan */}
            <div className="absolute inset-0 pointer-events-none">
              <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-indigo-600/8 rounded-full blur-3xl opacity-40 animate-pulse-slow" />
              <div className="absolute -bottom-40 right-1/3 w-96 h-96 bg-purple-600/8 rounded-full blur-3xl opacity-30 animate-pulse-slow delay-1500" />
            </div>

            <div className="relative inline-flex items-center gap-5 mb-6 md:mb-10">
              <div className="h-px w-16 md:w-24 bg-gradient-to-r from-transparent via-indigo-500/50 to-transparent" />
            ...
            <p className="mt-6 text-base md:text-lg lg:text-xl text-slate-300/90 max-w-3xl mx-auto font-light leading-relaxed">
              Tutoriels avancés • Bonnes pratiques • Retours d’expérience concrets • Technologies modernes 2025–2026
            </p>
          </div>
        </div>
        ...
        {/* ==================== GRILLE DES CARTES ==================== */}
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="h-px bg-gradient-to-r from-transparent via-slate-800 to-transparent my-10 md:my-16" />
            ...
            {posts.map((post: any) => (
              ...
              >
                ...
                <div className="relative aspect-[16/9] overflow-hidden bg-slate-950">
                  ...
                  {/* Gradient overlay */}
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/85 via-slate-950/30 to-transparent/20" />
                ...
                <div className="flex flex-col flex-1 p-5 md:p-6">
                  ...
                  <p className="mt-3 text-sm md:text-base text-slate-400/90 line-clamp-3 leading-relaxed flex-1">
                    {post.excerpt ||
                      (post.content ? post.content.substring(0, 160) + "..." : "Article en cours de rédaction...")}
                  </p>

                  {/* Footer de la carte */}
                  <div className="mt-6 pt-5 border-t border-slate-800/50 flex items-center justify-between text-sm">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-slate-200">FrankamDev</p>
                    ...
                    <span className="text-indigo-400/80 group-hover:text-indigo-300 transition-colors">
                      Lire →
                    </span>
                  </div>
                </div>

                {/* Effet glow subtil sur hover */}
                <div
                  className="
                    pointer-events-none absolute inset-0
